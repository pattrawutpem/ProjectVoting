                      ...
                      <div className="card border-primary  w-100">
                        ...
                        <div className="card-body text-primary">
                          <p className="card-title">
                            <i className="fa-sharp fs-5 bluetheme fa-sparkles me-2"></i>{" "}
                            {DataDeclare.detail}
                          </p>
                          <p className="card-text my-3">
                            <div className="row">
                              <div className="col-6">
                                <i className="lightbluetheme fa-sharp fa-regular fa-calendar-days me-2"></i>{" "}
                                {DataDeclare.start_date1} ถึงวันที่{" "}
                                {DataDeclare.end_date1}
                              </div>
                              <div className="col-6">
                                <i className="lightbluetheme fa-sharp fa-solid fa-clock-ten me-2"></i>{" "}
        ...
        <div className="py-3 mx-4">
          ...
          <div className="row lg:mx-5 my-4">
            <div className="col-12 col-lg-6">
              <img
                src={process.env.REACT_APP_PATH + `image/blockchain.png`}
                alt=""
                        ...
                        >
                          ...
                          <div className="card-body">
                            ...
                            <div className="text-center mt-3">
                              <Link
                                to={`/Candidate/1/${DataHoR.Representatives_id}/CandidateDetail/1`}
                              >
                      ...
                      {filteredCandidates.map((candidate) => (
                        ...
                        >
                          ...
                          <div className="card-body">
                            ...
                            <div className="text-center mt-3">
                              <Link
                                to={`/Candidate/2/${DataProvincial.provincial_id}/CandidateDetail/2`}
                              >
                                <button className="btn btn-outline-primary bg-gradient-to-tr hover:from-blue-600 hover:to-blue-400 fs-6 w-50">
                                  ข้อมูลผู้สมัคร
                                </button>
                      ...
                      {filteredCandidates.map((candidate) => (
                        ...
                        >
                          ...
                          <div className="card-body">
                            ...
                            <div className="text-center mt-3">
                              <Link
                                to={`/Candidate/3/${DataStudent.club_president_id}/CandidateDetail/3`}
                              >
                                <button className="btn btn-outline-primary bg-gradient-to-tr hover:from-blue-600 hover:to-blue-400 fs-6 w-50">
                                  ข้อมูลผู้สมัคร
                                </button>
                      ...
                      {filteredCandidates.map((candidate) => (
                        ...
                        >
                          ...
                          <div className="card-body">
                            ...
                            <div className="text-center mt-3">
                              <Link
                                to={`/Candidate/4/${DataOther.register_other_id}/CandidateDetail/4`}
                              >
                                <button className="btn btn-outline-primary bg-gradient-to-tr hover:from-blue-600 hover:to-blue-400 fs-6 w-50">
                                  ข้อมูลผู้สมัคร
                                </button>
          ...
          <div className="row lg:mx-5 my-4  text-center">
            <div className="col-12 col-lg-4">
              ...
              <div className="mt-3 fs-3 fw-bold">
                ...
                <p className="fs-5 text-danger">*ใน Metamsk จำเป็นต้องมีเหรียญ</p>
                <Link to="https://sepoliafaucet.com" className="fs-5 text-success" ><i class="fs-4 fa-sharp fa-light fa-circle-arrow-right" /> คลิกรับเหรียญ SepoliaETH</Link>
              </div>
            </div>
            <div className="col-12 col-lg-4">
              <img
