...
export default function Personal_House_of_Representatives() {
    ...
    const getData = async () => {
        try {
            const response = await axios.get(process.env.REACT_APP_API + `api_House_of_Representatives.php/${id}/?xCase=4`
            );
    ...
    const handleSubmit = (event) => {
        ...
        formData.append('Representatives_id', Datas.Representatives_id);
        formData.append("picture", img_File.files[0]);
        formData.append('number', Datas.number);
        formData.append('prefix', Datas.prefix);
        formData.append('Representatives_firstname', Datas.Representatives_firstname);
        formData.append('Representatives_lastname', Datas.Representatives_lastname);
        ...
        formData.append('Political_Party', Datas.Political_Party);
        ...
        axios.post(process.env.REACT_APP_API + `api_House_of_Representatives.php/${id}/?xCase=6`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        }).then(function (response) {
            console.log(response.data);
            navigate('../Candidate_House_of_Representatives');
        });
    }
    // sweetalert2
                    ...
                    <div className="card-type col-10 mx-lg my-5 mx-auto">
                        <div class="card">
                            <div class="card-header">
                                <strong><h4 class="text-center">{isChecked ? 'ดูรายละเอียด' : 'แก้ไข'}ข้อมูลของ {Datas.Representatives_firstname} {Datas.Representatives_lastname}</h4></strong>
                            </div>
                            <div class="card-body">
                                <div class="row row-cols-4">
                                    ...
                                    <div class="col-2">
                                        <label >เบอร์</label>
                                        <input type="text" class="form-control" name='Representatives_id' value={Datas.Representatives_id} hidden />
                                    ...
                                    <div class="col-4">
                                        <label >ชื่อ</label>
                                        <input type="text" class="form-control" name='Representatives_firstname' value={Datas.Representatives_firstname} onChange={handleChange} disabled />
                                    </div>
                                    <div class="col-4">
                                        <label >นามสกุล</label>
                                        <input type="text" class="form-control" name='Representatives_lastname' value={Datas.Representatives_lastname} onChange={handleChange} disabled />
                                    </div>
                                    <div class="col-2">
                                        <label >อายุ</label>
                                    ...
                                    <div class="col-4">
                                        <label>สังกัด</label>
                                        <input type="text" class="form-control" name='Political_Party' value={Datas.Political_Party} onChange={handleChange} disabled={isChecked} />
                                    </div>
                                    <div class="col-2">
