...
export default function Insert_House_of_Representatives() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (typeof window.ethereum !== "undefined") {
        ...
        const firstNameInput = Datas.Representatives_firstname.trim();
        const lastNameInput = Datas.Representatives_lastname.trim();
        const nameInput = `${firstNameInput} ${lastNameInput}`;
        const candidateTypeInput = "001";
    ...
    formData.append(
      "Representatives_firstname",
      Datas.Representatives_firstname
    );
    ...
    axios
      .post(
        process.env.REACT_APP_API + `api_House_of_Representatives.php/?xCase=5`,
        formData,
        {
          headers: {
      ...
      .catch(function (error) {
        console.error("เกิดข้อผิดพลาดในการส่งข้อมูลผู้สมัคร: ", error);
      });
  };
                  ...
                  <div className="row row-cols-4">
                    ...
                    <div className="col-4">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        name="Representatives_firstname"
                        value={Datas.Representatives_firstname}
                        onChange={handleChange}
                        required
                      />
                    </div>
                    <div className="col-4">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        name="Representatives_lastname"
                        value={Datas.Representatives_lastname}
                        onChange={handleChange}
                        required
                      />
                    </div>
